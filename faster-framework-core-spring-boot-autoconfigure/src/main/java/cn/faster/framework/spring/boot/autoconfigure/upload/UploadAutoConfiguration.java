...
import cn.faster.framework.core.upload.service.local.LocalUploadService;
import cn.faster.framework.spring.boot.autoconfigure.ProjectProperties;
import cn.faster.framework.spring.boot.autoconfigure.upload.local.LocalUploadProperties;
